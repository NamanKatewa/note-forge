...
const Footer = () => {
  return (
    <div className="footer">
      ...
      <footer>
        <div className="copy">
          <p>&copy; 2024 Note Forge. All Rights Reserved.</p>
        </div>
        <div className="icons">
          <a
            href="https://www.instagram.com/katewanaman/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a
            href="https://github.com/NamanKatewa"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a
            href="https://www.linkedin.com/in/namankatewa/"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <a href="https://dev.to/namankatewa" target="_blank" rel="noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
